        ...
        <form className='form' onSubmit={handleSubmit}>
            ...
            <div className='row_field'>
                <div className='field'>
                    ...
                    <input className='input' placeholder='Domaine' type='text' value={domaine} required onChange={(event) => setDomaine(event.target.value)} />
                </div>
                <div className='field'>
                    <label className='label'>Niveau</label>
                    <input className='input' placeholder='Niveau' type='text' value={niveau} required onChange={(event) => setNiveau(event.target.value)} />
                </div>
            </div>
            <div className='field'>
                <label className='label'>Désignation</label>
                <input className='input' placeholder='Désignation' type='text' value={designation} required onChange={(event) => setDesignation(event.target.value)} />
            </div>
